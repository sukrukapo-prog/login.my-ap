...
final _allTime = <LeaderboardEntry>[
  LeaderboardEntry(rank: 1, username: 'ZenMaster', avatarPath: 'assets/images/avatars/male_athlete.png', meditationMinutes: 320, movementMinutes: 180, workoutMinutes: 210, streakDays: 14, exercisesDone: 0),
  LeaderboardEntry(rank: 2, username: 'MindfulSoul', avatarPath: 'assets/images/avatars/male_zen.png', meditationMinutes: 280, movementMinutes: 200, workoutMinutes: 160, streakDays: 10, exercisesDone: 0),
  LeaderboardEntry(rank: 3, username: 'FlowState', avatarPath: 'assets/images/avatars/male_casual.png', meditationMinutes: 240, movementMinutes: 190, workoutMinutes: 140, streakDays: 8, exercisesDone: 0),
  LeaderboardEntry(rank: 4, username: 'You', avatarPath: 'assets/images/avatars/male_sporty.png', meditationMinutes: 180, movementMinutes: 120, workoutMinutes: 90, streakDays: 5, exercisesDone: 0, isCurrentUser: true),
  LeaderboardEntry(rank: 5, username: 'CalmVibes', avatarPath: 'assets/images/avatars/female_pilates.png', meditationMinutes: 160, movementMinutes: 100, workoutMinutes: 80, streakDays: 4, exercisesDone: 0),
  LeaderboardEntry(rank: 6, username: 'BreathWork', avatarPath: 'assets/images/avatars/female_casual.png', meditationMinutes: 140, movementMinutes: 90, workoutMinutes: 60, streakDays: 3, exercisesDone: 0),
  LeaderboardEntry(rank: 7, username: 'PeacefulOne', avatarPath: 'assets/images/avatars/male_runner.png', meditationMinutes: 120, movementMinutes: 80, workoutMinutes: 50, streakDays: 2, exercisesDone: 0),
  LeaderboardEntry(rank: 8, username: 'InnerPeace', avatarPath: 'assets/images/avatars/male_swimmer.png', meditationMinutes: 100, movementMinutes: 60, workoutMinutes: 40, streakDays: 1, exercisesDone: 0),
];

final _thisWeek = <LeaderboardEntry>[
  LeaderboardEntry(rank: 1, username: 'FlowState', avatarPath: 'assets/images/avatars/male_casual.png', meditationMinutes: 90, movementMinutes: 60, workoutMinutes: 50, streakDays: 8, exercisesDone: 0),
  LeaderboardEntry(rank: 2, username: 'You', avatarPath: 'assets/images/avatars/male_sporty.png', meditationMinutes: 80, movementMinutes: 50, workoutMinutes: 40, streakDays: 5, exercisesDone: 0, isCurrentUser: true),
  LeaderboardEntry(rank: 3, username: 'ZenMaster', avatarPath: 'assets/images/avatars/male_athlete.png', meditationMinutes: 70, movementMinutes: 45, workoutMinutes: 35, streakDays: 14, exercisesDone: 0),
  LeaderboardEntry(rank: 4, username: 'CalmVibes', avatarPath: 'assets/images/avatars/female_pilates.png', meditationMinutes: 60, movementMinutes: 40, workoutMinutes: 30, streakDays: 4, exercisesDone: 0),
  LeaderboardEntry(rank: 5, username: 'MindfulSoul', avatarPath: 'assets/images/avatars/male_zen.png', meditationMinutes: 50, movementMinutes: 30, workoutMinutes: 20, streakDays: 10, exercisesDone: 0),
];

final _today = <LeaderboardEntry>[
  LeaderboardEntry(rank: 1, username: 'You', avatarPath: 'assets/images/avatars/male_sporty.png', meditationMinutes: 30, movementMinutes: 20, workoutMinutes: 15, streakDays: 5, exercisesDone: 0, isCurrentUser: true),
  LeaderboardEntry(rank: 2, username: 'BreathWork', avatarPath: 'assets/images/avatars/female_casual.png', meditationMinutes: 25, movementMinutes: 15, workoutMinutes: 10, streakDays: 3, exercisesDone: 0),
  LeaderboardEntry(rank: 3, username: 'PeacefulOne', avatarPath: 'assets/images/avatars/male_runner.png', meditationMinutes: 20, movementMinutes: 10, workoutMinutes: 5, streakDays: 2, exercisesDone: 0),
  LeaderboardEntry(rank: 4, username: 'InnerPeace', avatarPath: 'assets/images/avatars/male_swimmer.png', meditationMinutes: 15, movementMinutes: 10, workoutMinutes: 5, streakDays: 1, exercisesDone: 0),
];
